...
PYTHON_FILES = python/lvdgdmsiuy.pyx python/setup.py python/clvdgdmsiuy.pxd python/test_class.py

all: class libclass.a lvdgdmsiuy
...
lvdgdmsiuy: libclass.a python/lvdgdmsiuy.pyx python/clvdgdmsiuy.pxd
    ...
    if echo "$$output" | grep -q "ERROR: Cannot uninstall"; then \
        ...
        rm -rf $$site_packages/lvdgdmsiuy* && \
