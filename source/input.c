...
int input_read_parameters_general(struct file_content * pfc,
  ...
  char * options_output[39] =  {"tCl","pCl","lCl","nCl","dCl","sCl","mPk","mTk","dTk","vTk","sd",
                                "TCl","PCl","LCl","NCl","DCl","SCl","MPk","MTk","DTk","VTk","Sd",
                                "TCL","PCL","LCL","NCL","DCL","SCL","MPK","MTK","DTK","VTK","SD",
                                "wPk","WPk","WPK","wTk","WTk","WTK"};
  ...
  if (flag1 == _TRUE_) {
    ...
    class_test(flag1==_FALSE_,
               errmsg, "The options for output are {'tCl','pCl','lCl','nCl','dCl','sCl','mPk','mTk','dTk','vTk','Sd','wTk','wPk'}, you entered '%s'",string1);
  }
...
int input_read_parameters_spectra(struct file_content * pfc,
  ...
  if ((ppt->has_pk_matter == _TRUE_) || (ppt->has_pk_weyl == _TRUE_) || (ppt->has_density_transfers == _TRUE_) || (ppt->has_velocity_transfers == _TRUE_) || (ppt->has_pk_weyl == _TRUE_)){
  ...
  if ((ppt->has_pk_matter == _TRUE_) || (ppt->has_density_transfers == _TRUE_) || (ppt->has_velocity_transfers == _TRUE_) || (ppt->has_cl_number_count == _TRUE_) || (ppt->has_cl_lensing_potential == _TRUE_) || (ppt->has_vector_velocity_transfers == _TRUE_) || (ppt->has_pk_weyl == _TRUE_)) {
    /* Read */
     ...
     * */
      ...
      if ((ppt->has_pk_matter == _TRUE_) || (ppt->has_density_transfers == _TRUE_) || (ppt->has_velocity_transfers == _TRUE_) || (ppt->has_vector_velocity_transfers == _TRUE_) || (ppt->has_pk_weyl == _TRUE_)) {
